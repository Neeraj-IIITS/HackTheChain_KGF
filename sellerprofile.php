                            ...
                            <div class="form-row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" name="sellername" id="sellername"
                                        value="<?php echo $rsedit['seller_name']; ?>" autofocus class="form-control">
                                </div>

                                <div class="col-md-6 form-group">
                                    Email ID <font color="#FF0000">*</font>
                                    <input type="email" name="emailid" id="emailid"
                                        value="<?php echo $rsedit['email_id']; ?>" class="form-control">
                                </div>


                                <div class="col-md-12 form-group">
                                    Address <font color="#FF0000">*</font>
                                    <textarea name="selleraddress" id="selleraddress"
                                        class="form-control"><?php echo $rsedit['seller_address']; ?></textarea>
                                </div>

                                <div class="col-md-6 form-group">
                                    Country <font color="#FF0000"> *</font>
                                    <select name="country" id="country" onChange="loadstate(this.value)"
                                        class="form-control">
		  ...
		  ?>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="number" name="pincode" id="pincode"
                                        value="<?php echo $rsedit['pincode']; ?>" class="form-control">
                                </div>

                                <div class="col-md-6 form-group">
                                    Contact Number <font color="#FF0000"> *</font>
                                    <input type="number" name="contactnumber" id="contactnumber"
                                        value="<?php echo $rsedit['contact_number']; ?>" class="form-control">
                                </div>

                                <div class="col-md-6 form-group">
                                    Mobile Number <font color="#FF0000"> *</font>
                                    <input type="number" name="mbnumber" id="mbnumber"
                                        value="<?php echo $rsedit['mobile_no']; ?>" class="form-control">
                                </div>
                            </div>
                            <hr>
                            <button type="submit" name="submit" id="submit" class="btn btn-info btn-lg btn-block">Click
                                here to Update Profile</button>
