                    ...
                    <div class="info mt-4 ">
                        ...
                        <?php
							 $sql = "SELECT * FROM seller";
							  ...
							  if(mysqli_num_rows($qsql)  == 0)
									{
										echo "<center>There is no Company to display!!</center>";
									}
									else
									{
							?>
                        <table ID="datatable" class="table table-striped table-bordered" style="width:100%">
						    ...
						    <tr>
						      ...
						      <td>&nbsp;$rs[status]</td>
						      <td>&nbsp; 
								<a href='seller.php?editid=$rs[seller_id]' class='btn btn-info'>Edit</a>
								<br>
								<a href='viewseller.php?deleteid=$rs[seller_id]' onclick='return delconfirm()' class='btn btn-danger'>Delete</a>
							  </td>
					        </tr>";
							  }
							  ?>
