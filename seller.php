...
if(isset($_POST['submit']))
{
	...
	{
$sql="INSERT INTO seller(seller_name, seller_address, state_id, country_id, city_id, pincode, contact_number, mobile_no, email_id, password,'$_POST[status]')";	
	if(!mysqli_query($con,$sql))
		{
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Company Registration Panel</h2>
          <ol>
            ...
            <div class="row">
              ...
              <div class="col-md-3 d-flex align-items-stretch mt-4 mt-lg-0">
                <div class="icon-box" data-aos="zoom-in" data-aos-delay="200" style="width: 100%;">
                  ...
                  <img src="images/company_pic.jpg" style="width: 100%;">
                </div>
              </div>
