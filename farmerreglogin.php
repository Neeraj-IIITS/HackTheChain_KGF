            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="section-title" data-aos="fade-right">
                        <h2>Company Login/Register</h2>
                        <p>Online platform links Companies to students and engage them with their wonderful Events and Competitions according to their interest....<br></p>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="row">
                        ...
                        <div class="col-md-6 d-flex align-items-stretch">
                            <div class="icon-box" data-aos="zoom-in" data-aos-delay="100" style="width: 100%;">
                                ...
                                <h4><a href="sellerloginpanel.php">Existing Company</a></h4>

                                <button type="button" class="btn btn-info btn-lg btn-block"
                                    onclick="window.location='sellerloginpanel.php'">Sign In & Get Started</button>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
                            <div class="icon-box" data-aos="zoom-in" data-aos-delay="200" style="width: 100%;">
                                ...
                                <button type="button" class="btn btn-warning btn-lg btn-block"
                                    onclick="window.location='seller.php'">Sign Up (It's Free)</button>
                            </div>
                        </div>
