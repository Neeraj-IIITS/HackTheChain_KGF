    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <h2>College Staff/Admin Login Panel</h2>
                <ol>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 d-flex align-items-stretch mt-4 mt-lg-0">
                            <div class="icon-box" data-aos="zoom-in" data-aos-delay="200" style="width: 100%;">
                                <h4>Admin Login</h4>
                                <img src="images/college_pic.jpg" style="width: 100%;">
                            </div>
                        </div>
                                ...
                                <form method="post" action="" name="frmadminlogin"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="emailid" name="emailid"
                                            aria-describedby="emailHelp" placeholder="Enter Login ID">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <button type="submit" name="submit" id="submit"
                                        class="btn btn-info btn-lg btn-block">Click here to Login</button>
