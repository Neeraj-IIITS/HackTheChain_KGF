                            ...
                            <div class="form-row">
                                <div class="col-md-12 form-group">
                                    ...
                                    <input type="text" name="adminname" id="adminname"
                                        value="<?php echo $rsedit['admin_name']; ?>" autofocus class="form-control">
                                </div>

                                <div class="col-md-12 form-group">
                                    Login ID <font color="#FF0000">*</font>
                                    <input type="text" name="loginid" id="loginid"
                                        value="<?php echo $rsedit['login_id']; ?>" class="form-control">
                                </div>

                                <div class="col-md-12 form-group">
                                    Password <font color="#FF0000">*</font>
                                    <input type="Password" name="password" id="password"
                                        value="<?php echo $rsedit['password']; ?>" class="form-control">
                                    <font color="#FF0000"> (Password must be of Minimum 8 Characters and Maximum 16
